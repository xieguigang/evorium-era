...
Namespace BiologicalRules.Rules
    ...
    Public Class OsmoregulationRule : Inherits IBiochemicalRule
        ...
        Sub New()
            Call MyBase.New(
                GeneOntology.Osmoregulation,
                GeneOntology.CompatibleSoluteSynthesis
            )
        End Sub
        ...
        Public Overrides Sub Execute(cell As Cell, env As NaturalEnvironment)
            ...
            If osmoticDiff > 50 Then ' 显著高渗
                ...
                If waterLoss > 0 Then
                    ...
                    voxel.ExternalMolecules(MoleculeType.Water) =
                        voxel.GetMoleculeAmount(MoleculeType.Water) + waterLoss
                End If
                ...
                If cell.HasFunction(GeneOntology.Osmoregulation) Then
                    ...
                    If cell.ATP >= 3 Then
                        ...
                        If naOut > 0 Then
                            ...
                            voxel.ExternalMolecules(MoleculeType.SodiumIon) =
                                voxel.GetMoleculeAmount(MoleculeType.SodiumIon) + naOut
                        End If
                        ' 吸收K+从环境
                        ...
                        If kIn > 0 Then
                            ...
                            voxel.ExternalMolecules(MoleculeType.PotassiumIon) =
                                voxel.GetMoleculeAmount(MoleculeType.PotassiumIon) - kIn
                        End If
                    End If
                End If
            ...
            If osmoticDiff < -50 Then ' 显著低渗
                ...
                If waterGain > 0 Then
                    ...
                    voxel.ExternalMolecules(MoleculeType.Water) = Math.Max(0, envWater - waterGain)
                End If
                ...
                If cell.HasFunction(GeneOntology.Osmoregulation) Then
                    If cell.ATP >= 2 Then
                        ...
                        If kOut > 0 Then
                            ...
                            voxel.ExternalMolecules(MoleculeType.PotassiumIon) =
                                voxel.GetMoleculeAmount(MoleculeType.PotassiumIon) + kOut
                        End If
                    End If
                End If
            End If
